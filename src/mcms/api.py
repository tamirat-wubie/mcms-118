...
def _index_payload() -> dict[str, Any]:
    return {
        ...
        "routes": [
            ...
            "GET /atom/behavior/gaps/Tc",
            "GET /atom/behavior/workplan",
            "GET /atom/behavior/workplan/Tc",
            "GET /atom/behavior/isotope-source-policy",
            "GET /atom/behavior/isotope-source-policy/Tc",
            "GET /atom/behavior/isotope-source-search",
            "GET /atom/behavior/isotope-source-search/Tc",
            "GET /atom/behavior/isotope-candidate-evidence",
            "GET /atom/behavior/isotope-candidate-evidence/template/Tc",
            ...
            "GET /evidence/isotopes/unresolved/Tc",
