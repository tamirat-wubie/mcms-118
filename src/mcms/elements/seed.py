"""Purpose: deterministic MSPEE Level 1 seed pack for the first 20 elements.
...
Invariants: first seed pack contains Z=1..20 in order; no value is inferred without a
...
def validate_seed_pack(
    ...
    expected_atomic_numbers = tuple(range(1, 21))
