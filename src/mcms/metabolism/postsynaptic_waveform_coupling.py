"""Postsynaptic Waveform Coupling

Generated scaffold for Phase 119: Multi-Release-Site Active Zone, Vesicle Position Grid, CaV Subtype Specificity, Monte Carlo Release Trace, and Postsynaptic Waveform Coupling
...
PHASE = 119
MODULE = 'postsynaptic_waveform_coupling'
PHASE_TITLE = 'Multi-Release-Site Active Zone, Vesicle Position Grid, CaV Subtype Specificity, Monte Carlo Release Trace, and Postsynaptic Waveform Coupling'
