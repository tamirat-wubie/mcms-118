# MCMS-118-P020 — Conflict Repair and Evidence Downgrade Engine
...
Phase ID: MCMS-118-P020
Slug: conflict-repair-and-evidence-downgrade-engine
Metadata: docs/phase_metadata/phase_020.json
```
...
Model, govern, and audit: Conflict Repair → Evidence Downgrade Engine.

## Capability chain

```text
Conflict Repair → Evidence Downgrade Engine
```
...
```text
Phase doc: docs/phases/phase_020.md
Phase metadata: docs/phase_metadata/phase_020.json
