# MCMS-118-P070 — Reaction Kinetics, Activation Energy, Rate Laws, and Catalyst Reasoning
...
Phase ID: MCMS-118-P070
Slug: reaction-kinetics-activation-energy-rate-laws-and-catalyst-reasoning
Metadata: docs/phase_metadata/phase_070.json
```
...
Model, govern, and audit: Reaction Kinetics → Activation Energy → Rate Laws → and Catalyst Reasoning.

## Capability chain

```text
Reaction Kinetics → Activation Energy → Rate Laws → and Catalyst Reasoning
```
...
```text
Phase doc: docs/phases/phase_070.md
Phase metadata: docs/phase_metadata/phase_070.json
