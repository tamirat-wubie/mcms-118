# MCMS-118-P050 — Unit Normalization, Context-Aware Claims, and Measurement Conditions
...
Phase ID: MCMS-118-P050
Slug: unit-normalization-context-aware-claims-and-measurement-conditions
Metadata: docs/phase_metadata/phase_050.json
```
...
Model, govern, and audit: Unit Normalization → Context-Aware Claims → and Measurement Conditions.

## Capability chain

```text
Unit Normalization → Context-Aware Claims → and Measurement Conditions
```
...
```text
Phase doc: docs/phases/phase_050.md
Phase metadata: docs/phase_metadata/phase_050.json
