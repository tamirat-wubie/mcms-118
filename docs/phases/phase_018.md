# MCMS-118-P018 — Explicit State Node Expansion
...
Phase ID: MCMS-118-P018
Slug: explicit-state-node-expansion
Metadata: docs/phase_metadata/phase_018.json
```
...
Model, govern, and audit: Explicit State Node Expansion.

## Capability chain

```text
Explicit State Node Expansion
```
...
```text
Phase doc: docs/phases/phase_018.md
Phase metadata: docs/phase_metadata/phase_018.json
