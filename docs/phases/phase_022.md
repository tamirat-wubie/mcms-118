# MCMS-118-P022 — Repair Action Registry and Multi-Step Repair Workflow
...
Phase ID: MCMS-118-P022
Slug: repair-action-registry-and-multi-step-repair-workflow
Metadata: docs/phase_metadata/phase_022.json
```
...
Model, govern, and audit: Repair Action Registry → Multi-Step Repair Workflow.

## Capability chain

```text
Repair Action Registry → Multi-Step Repair Workflow
```
...
```text
Phase doc: docs/phases/phase_022.md
Phase metadata: docs/phase_metadata/phase_022.json
