# MCMS-118-P083 — Lipid Peroxidation, Membrane Damage, Ferroptosis Boundary, and Repair Systems
...
Phase ID: MCMS-118-P083
Slug: lipid-peroxidation-membrane-damage-ferroptosis-boundary-and-repair-systems
Metadata: docs/phase_metadata/phase_083.json
```
...
Model, govern, and audit: Lipid Peroxidation → Membrane Damage → Ferroptosis Boundary → and Repair Systems.

## Capability chain

```text
Lipid Peroxidation → Membrane Damage → Ferroptosis Boundary → and Repair Systems
```
...
```text
Phase doc: docs/phases/phase_083.md
Phase metadata: docs/phase_metadata/phase_083.json
