# MCMS-118-P006 — Symbolic Reaction Engine
...
Phase ID: MCMS-118-P006
Slug: symbolic-reaction-engine
Metadata: docs/phase_metadata/phase_006.json
```
...
Model, govern, and audit: Symbolic Reaction Engine.

## Capability chain

```text
Symbolic Reaction Engine
```
...
```text
Phase doc: docs/phases/phase_006.md
Phase metadata: docs/phase_metadata/phase_006.json
