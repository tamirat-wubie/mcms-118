# MCMS-118-P114 — Arc/Arg3.1 Endocytosis, Homeostatic Synaptic Scaling, Receptor Nanodomains, and Spine-Neighborhood Coupling
...
Phase ID: MCMS-118-P114
Slug: arc-arg3-1-endocytosis-homeostatic-synaptic-scaling-receptor-nanodomains-and-spine-neighborhood-coupling
Metadata: docs/phase_metadata/phase_114.json
```
...
Model, govern, and audit: Arc/Arg3.1 Endocytosis → Homeostatic Synaptic Scaling → Receptor Nanodomains → and Spine-Neighborhood Coupling.

## Capability chain

```text
Arc/Arg3.1 Endocytosis → Homeostatic Synaptic Scaling → Receptor Nanodomains → and Spine-Neighborhood Coupling
```
...
```text
Phase doc: docs/phases/phase_114.md
Phase metadata: docs/phase_metadata/phase_114.json
