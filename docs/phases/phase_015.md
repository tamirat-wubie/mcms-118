# MCMS-118-P015 — Evidence Adapter and Persistent Causal Graph Kernel
...
Phase ID: MCMS-118-P015
Slug: evidence-adapter-and-persistent-causal-graph-kernel
Metadata: docs/phase_metadata/phase_015.json
```
...
Model, govern, and audit: Evidence Adapter → Persistent Causal Graph Kernel.

## Capability chain

```text
Evidence Adapter → Persistent Causal Graph Kernel
```
...
```text
Phase doc: docs/phases/phase_015.md
Phase metadata: docs/phase_metadata/phase_015.json
