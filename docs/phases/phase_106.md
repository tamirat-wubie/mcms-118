# MCMS-118-P106 — Temporal Summation, Back-Propagating Action Potentials, Conductance Synapses, and Dendritic Spike Classes
...
Phase ID: MCMS-118-P106
Slug: temporal-summation-back-propagating-action-potentials-conductance-synapses-and-dendritic-spike-classes
Metadata: docs/phase_metadata/phase_106.json
```
...
Model, govern, and audit: Temporal Summation → Back-Propagating Action Potentials → Conductance Synapses → and Dendritic Spike Classes.

## Capability chain

```text
Temporal Summation → Back-Propagating Action Potentials → Conductance Synapses → and Dendritic Spike Classes
```
...
```text
Phase doc: docs/phases/phase_106.md
Phase metadata: docs/phase_metadata/phase_106.json
