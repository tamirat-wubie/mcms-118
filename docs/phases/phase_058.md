# MCMS-118-P058 — Equilibrium Solver, ICE Tables, and Polyprotic Acid Expansion
...
Phase ID: MCMS-118-P058
Slug: equilibrium-solver-ice-tables-and-polyprotic-acid-expansion
Metadata: docs/phase_metadata/phase_058.json
```
...
Model, govern, and audit: Equilibrium Solver → ICE Tables → and Polyprotic Acid Expansion.

## Capability chain

```text
Equilibrium Solver → ICE Tables → and Polyprotic Acid Expansion
```
...
```text
Phase doc: docs/phases/phase_058.md
Phase metadata: docs/phase_metadata/phase_058.json
