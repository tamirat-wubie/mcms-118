# MCMS-118-P098 — Glutamate-Glutamine Cycle, Astrocyte Recycling, Nitrogen Handling, and Excitotoxicity Boundary
...
Phase ID: MCMS-118-P098
Slug: glutamate-glutamine-cycle-astrocyte-recycling-nitrogen-handling-and-excitotoxicity-boundary
Metadata: docs/phase_metadata/phase_098.json
```
...
Model, govern, and audit: Glutamate-Glutamine Cycle → Astrocyte Recycling → Nitrogen Handling → and Excitotoxicity Boundary.

## Capability chain

```text
Glutamate-Glutamine Cycle → Astrocyte Recycling → Nitrogen Handling → and Excitotoxicity Boundary
```
...
```text
Phase doc: docs/phases/phase_098.md
Phase metadata: docs/phase_metadata/phase_098.json
