# MCMS-118-P091 — NAD Compartmentalization, Salvage Pathway, NAMPT/NMN Flow, and Organelle-Specific NAD Pools
...
Phase ID: MCMS-118-P091
Slug: nad-compartmentalization-salvage-pathway-nampt-nmn-flow-and-organelle-specific-nad-pools
Metadata: docs/phase_metadata/phase_091.json
```
...
Layer: NAD, lactate, transporters, and intercellular metabolic shuttle
```

## Objective

Model, govern, and audit: NAD Compartmentalization → Salvage Pathway → NAMPT/NMN Flow → and Organelle-Specific NAD Pools.

## Capability chain

```text
NAD Compartmentalization → Salvage Pathway → NAMPT/NMN Flow → and Organelle-Specific NAD Pools
```
...
```text
Phase doc: docs/phases/phase_091.md
Phase metadata: docs/phase_metadata/phase_091.json
