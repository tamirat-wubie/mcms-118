# MCMS-118-P003 — Lanthanide/Actinide and Nuclear Kernel
...
Phase ID: MCMS-118-P003
Slug: lanthanide-actinide-and-nuclear-kernel
Metadata: docs/phase_metadata/phase_003.json
```
...
Layer: element identity foundation
```

## Objective

Model, govern, and audit: Lanthanide/Actinide → Nuclear Kernel.

## Capability chain

```text
Lanthanide/Actinide → Nuclear Kernel
```
...
```text
Phase doc: docs/phases/phase_003.md
Phase metadata: docs/phase_metadata/phase_003.json
