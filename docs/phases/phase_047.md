# MCMS-118-P047 — Source-Grounded Evidence Adapter and Claim Validation Layer
...
Phase ID: MCMS-118-P047
Slug: source-grounded-evidence-adapter-and-claim-validation-layer
Metadata: docs/phase_metadata/phase_047.json
```
...
Model, govern, and audit: Source-Grounded Evidence Adapter → Claim Validation Layer.

## Capability chain

```text
Source-Grounded Evidence Adapter → Claim Validation Layer
```
...
```text
Phase doc: docs/phases/phase_047.md
Phase metadata: docs/phase_metadata/phase_047.json
