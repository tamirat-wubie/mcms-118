# MCMS-118-P067 — Official Source Adapter Implementation, Freshness Policy, and Evidence Aging
...
Phase ID: MCMS-118-P067
Slug: official-source-adapter-implementation-freshness-policy-and-evidence-aging
Metadata: docs/phase_metadata/phase_067.json
```
...
Model, govern, and audit: Official Source Adapter Implementation → Freshness Policy → and Evidence Aging.

## Capability chain

```text
Official Source Adapter Implementation → Freshness Policy → and Evidence Aging
```
...
```text
Phase doc: docs/phases/phase_067.md
Phase metadata: docs/phase_metadata/phase_067.json
