# MCMS-118-P112 — AMPAR Subunits, TARPs/Stargazin, Endocytosis/Exocytosis, Perisynaptic Reserve Pool, and Maintenance Feedback
...
Phase ID: MCMS-118-P112
Slug: ampar-subunits-tarps-stargazin-endocytosis-exocytosis-perisynaptic-reserve-pool-and-maintenance-feedback
Metadata: docs/phase_metadata/phase_112.json
```
...
Model, govern, and audit: AMPAR Subunits → TARPs/Stargazin → Endocytosis/Exocytosis → Perisynaptic Reserve Pool → and Maintenance Feedback.

## Capability chain

```text
AMPAR Subunits → TARPs/Stargazin → Endocytosis/Exocytosis → Perisynaptic Reserve Pool → and Maintenance Feedback
```
...
```text
Phase doc: docs/phases/phase_112.md
Phase metadata: docs/phase_metadata/phase_112.json
