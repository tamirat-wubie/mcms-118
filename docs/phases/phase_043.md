# MCMS-118-P043 — Guided Action Wizards and Trusted Payload Builder
...
Phase ID: MCMS-118-P043
Slug: guided-action-wizards-and-trusted-payload-builder
Metadata: docs/phase_metadata/phase_043.json
```
...
Model, govern, and audit: Guided Action Wizards → Trusted Payload Builder.

## Capability chain

```text
Guided Action Wizards → Trusted Payload Builder
```
...
```text
Phase doc: docs/phases/phase_043.md
Phase metadata: docs/phase_metadata/phase_043.json
