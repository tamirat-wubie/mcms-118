# MCMS-118-P026 — Retry Workflow Builder and Operator Console MVP
...
Phase ID: MCMS-118-P026
Slug: retry-workflow-builder-and-operator-console-mvp
Metadata: docs/phase_metadata/phase_026.json
```
...
Model, govern, and audit: Retry Workflow Builder → Operator Console MVP.

## Capability chain

```text
Retry Workflow Builder → Operator Console MVP
```
...
```text
Phase doc: docs/phases/phase_026.md
Phase metadata: docs/phase_metadata/phase_026.json
