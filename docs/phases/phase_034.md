# MCMS-118-P034 — Hardware-Backed Approval and WebAuthn Governance
...
Phase ID: MCMS-118-P034
Slug: hardware-backed-approval-and-webauthn-governance
Metadata: docs/phase_metadata/phase_034.json
```
...
Model, govern, and audit: Hardware-Backed Approval → WebAuthn Governance.

## Capability chain

```text
Hardware-Backed Approval → WebAuthn Governance
```
...
```text
Phase doc: docs/phases/phase_034.md
Phase metadata: docs/phase_metadata/phase_034.json
