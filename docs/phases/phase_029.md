# MCMS-118-P029 — Signed Receipts and External Ledger Checkpoints
...
Phase ID: MCMS-118-P029
Slug: signed-receipts-and-external-ledger-checkpoints
Metadata: docs/phase_metadata/phase_029.json
```
...
Model, govern, and audit: Signed Receipts → External Ledger Checkpoints.

## Capability chain

```text
Signed Receipts → External Ledger Checkpoints
```
...
```text
Phase doc: docs/phases/phase_029.md
Phase metadata: docs/phase_metadata/phase_029.json
