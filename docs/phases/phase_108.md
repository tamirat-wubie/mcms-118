# MCMS-118-P108 — Hodgkin-Huxley Gate Approximation, Channel State Variables, Calcium Buffering, and Multi-Compartment Solver
...
Phase ID: MCMS-118-P108
Slug: hodgkin-huxley-gate-approximation-channel-state-variables-calcium-buffering-and-multi-compartment-solver
Metadata: docs/phase_metadata/phase_108.json
```
...
Model, govern, and audit: Hodgkin-Huxley Gate Approximation → Channel State Variables → Calcium Buffering → and Multi-Compartment Solver.

## Capability chain

```text
Hodgkin-Huxley Gate Approximation → Channel State Variables → Calcium Buffering → and Multi-Compartment Solver
```
...
```text
Phase doc: docs/phases/phase_108.md
Phase metadata: docs/phase_metadata/phase_108.json
