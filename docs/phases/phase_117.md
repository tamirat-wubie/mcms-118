# MCMS-118-P117 — SNARE/Synaptotagmin Vesicle Fusion, Short-Term Facilitation/Depression, Synchronous/Asynchronous Release, and Tripartite Energy Coupling
...
Phase ID: MCMS-118-P117
Slug: snare-synaptotagmin-vesicle-fusion-short-term-facilitation-depression-synchronous-asynchronous-release-and-tripartite-en
Metadata: docs/phase_metadata/phase_117.json
```
...
Model, govern, and audit: SNARE/Synaptotagmin Vesicle Fusion → Short-Term Facilitation/Depression → Synchronous/Asynchronous Release → and Tripartite Energy Coupling.

## Capability chain

```text
SNARE/Synaptotagmin Vesicle Fusion → Short-Term Facilitation/Depression → Synchronous/Asynchronous Release → and Tripartite Energy Coupling
```
...
```text
Phase doc: docs/phases/phase_117.md
Phase metadata: docs/phase_metadata/phase_117.json
