# MCMS-118-P012 — API, UI, Agent Interface
...
Phase ID: MCMS-118-P012
Slug: api-ui-agent-interface
Metadata: docs/phase_metadata/phase_012.json
```
...
Model, govern, and audit: API → UI → Agent Interface.

## Capability chain

```text
API → UI → Agent Interface
```
...
```text
Phase doc: docs/phases/phase_012.md
Phase metadata: docs/phase_metadata/phase_012.json
