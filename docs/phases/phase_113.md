# MCMS-118-P113 — GluA2/GRIP/PICK1 Trafficking, Recycling Endosomes, PKMζ-Like Maintenance, and Heterosynaptic Receptor Competition
...
Phase ID: MCMS-118-P113
Slug: glua2-grip-pick1-trafficking-recycling-endosomes-pkm-like-maintenance-and-heterosynaptic-receptor-competition
Metadata: docs/phase_metadata/phase_113.json
```
...
Model, govern, and audit: GluA2/GRIP/PICK1 Trafficking → Recycling Endosomes → PKMζ-Like Maintenance → and Heterosynaptic Receptor Competition.

## Capability chain

```text
GluA2/GRIP/PICK1 Trafficking → Recycling Endosomes → PKMζ-Like Maintenance → and Heterosynaptic Receptor Competition
```
...
```text
Phase doc: docs/phases/phase_113.md
Phase metadata: docs/phase_metadata/phase_113.json
