# MCMS-118-P101 — Spike-Timing Plasticity, Metaplasticity Threshold, Neuromodulator Gate, and Late-LTP Boundary
...
Phase ID: MCMS-118-P101
Slug: spike-timing-plasticity-metaplasticity-threshold-neuromodulator-gate-and-late-ltp-boundary
Metadata: docs/phase_metadata/phase_101.json
```
...
Model, govern, and audit: Spike-Timing Plasticity → Metaplasticity Threshold → Neuromodulator Gate → and Late-LTP Boundary.

## Capability chain

```text
Spike-Timing Plasticity → Metaplasticity Threshold → Neuromodulator Gate → and Late-LTP Boundary
```
...
```text
Phase doc: docs/phases/phase_101.md
Phase metadata: docs/phase_metadata/phase_101.json
