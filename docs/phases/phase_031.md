# MCMS-118-P031 — Signed Vote Receipts and Multisig Session UI
...
Phase ID: MCMS-118-P031
Slug: signed-vote-receipts-and-multisig-session-ui
Metadata: docs/phase_metadata/phase_031.json
```
...
Model, govern, and audit: Signed Vote Receipts → Multisig Session UI.

## Capability chain

```text
Signed Vote Receipts → Multisig Session UI
```
...
```text
Phase doc: docs/phases/phase_031.md
Phase metadata: docs/phase_metadata/phase_031.json
