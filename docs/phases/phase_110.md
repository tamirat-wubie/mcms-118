# MCMS-118-P110 — CaMKII/Calcineurin Switch, Spine Apparatus Calcium Stores, Actin Remodeling, and AMPA Stabilization
...
Phase ID: MCMS-118-P110
Slug: camkii-calcineurin-switch-spine-apparatus-calcium-stores-actin-remodeling-and-ampa-stabilization
Metadata: docs/phase_metadata/phase_110.json
```
...
Model, govern, and audit: CaMKII/Calcineurin Switch → Spine Apparatus Calcium Stores → Actin Remodeling → and AMPA Stabilization.

## Capability chain

```text
CaMKII/Calcineurin Switch → Spine Apparatus Calcium Stores → Actin Remodeling → and AMPA Stabilization
```
...
```text
Phase doc: docs/phases/phase_110.md
Phase metadata: docs/phase_metadata/phase_110.json
