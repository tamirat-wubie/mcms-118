# MCMS-118-P071 — Experimental Rate Law Fitting, Reaction Order Discovery, and Kinetic Model Selection
...
Phase ID: MCMS-118-P071
Slug: experimental-rate-law-fitting-reaction-order-discovery-and-kinetic-model-selection
Metadata: docs/phase_metadata/phase_071.json
```
...
Layer: thermodynamics, kinetics, enzymes, and metabolic networks
```

## Objective

Model, govern, and audit: Experimental Rate Law Fitting → Reaction Order Discovery → and Kinetic Model Selection.

## Capability chain

```text
Experimental Rate Law Fitting → Reaction Order Discovery → and Kinetic Model Selection
```
...
```text
Phase doc: docs/phases/phase_071.md
Phase metadata: docs/phase_metadata/phase_071.json
