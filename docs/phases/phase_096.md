# MCMS-118-P096 — Astrocyte-Neuron Lactate Shuttle, Brain Energy Coupling, and Local Support Networks
...
Phase ID: MCMS-118-P096
Slug: astrocyte-neuron-lactate-shuttle-brain-energy-coupling-and-local-support-networks
Metadata: docs/phase_metadata/phase_096.json
```
...
Model, govern, and audit: Astrocyte-Neuron Lactate Shuttle → Brain Energy Coupling → and Local Support Networks.

## Capability chain

```text
Astrocyte-Neuron Lactate Shuttle → Brain Energy Coupling → and Local Support Networks
```
...
```text
Phase doc: docs/phases/phase_096.md
Phase metadata: docs/phase_metadata/phase_096.json
