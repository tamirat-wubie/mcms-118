# MCMS-118-P105 — Multicompartment Dendritic Tree, Voltage Attenuation, Branch Bifurcation, and Electrical Integration
...
Phase ID: MCMS-118-P105
Slug: multicompartment-dendritic-tree-voltage-attenuation-branch-bifurcation-and-electrical-integration
Metadata: docs/phase_metadata/phase_105.json
```
...
Model, govern, and audit: Multicompartment Dendritic Tree → Voltage Attenuation → Branch Bifurcation → and Electrical Integration.

## Capability chain

```text
Multicompartment Dendritic Tree → Voltage Attenuation → Branch Bifurcation → and Electrical Integration
```
...
Phase metadata: docs/phase_metadata/phase_105.json
