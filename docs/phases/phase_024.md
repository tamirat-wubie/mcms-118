# MCMS-118-P024 — Semantic Rollback, Stale Conflict Marking, Retry Strategy
...
Phase ID: MCMS-118-P024
Slug: semantic-rollback-stale-conflict-marking-retry-strategy
Metadata: docs/phase_metadata/phase_024.json
```
...
Layer: graph evidence, conflict detection, repair, and rollback
```

## Objective

Model, govern, and audit: Semantic Rollback → Stale Conflict Marking → Retry Strategy.

## Capability chain

```text
Semantic Rollback → Stale Conflict Marking → Retry Strategy
```
...
```text
Phase doc: docs/phases/phase_024.md
Phase metadata: docs/phase_metadata/phase_024.json
