# MCMS-118-P011 — Knowledge Graph and Causal Memory
...
Phase ID: MCMS-118-P011
Slug: knowledge-graph-and-causal-memory
Metadata: docs/phase_metadata/phase_011.json
```
...
Model, govern, and audit: Knowledge Graph → Causal Memory.

## Capability chain

```text
Knowledge Graph → Causal Memory
```
...
```text
Phase doc: docs/phases/phase_011.md
Phase metadata: docs/phase_metadata/phase_011.json
