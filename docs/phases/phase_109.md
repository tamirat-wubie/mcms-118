# MCMS-118-P109 — Calcium Diffusion, Buffer Mobility, Spine-Neck Compartmentalization, and Local Biochemical Coupling
...
Phase ID: MCMS-118-P109
Slug: calcium-diffusion-buffer-mobility-spine-neck-compartmentalization-and-local-biochemical-coupling
Metadata: docs/phase_metadata/phase_109.json
```
...
Model, govern, and audit: Calcium Diffusion → Buffer Mobility → Spine-Neck Compartmentalization → and Local Biochemical Coupling.

## Capability chain

```text
Calcium Diffusion → Buffer Mobility → Spine-Neck Compartmentalization → and Local Biochemical Coupling
```
...
```text
Phase doc: docs/phases/phase_109.md
Phase metadata: docs/phase_metadata/phase_109.json
