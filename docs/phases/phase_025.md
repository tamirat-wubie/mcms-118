# MCMS-118-P025 — Lifecycle-Aware Conflict Query and Recovery Console API
...
Phase ID: MCMS-118-P025
Slug: lifecycle-aware-conflict-query-and-recovery-console-api
Metadata: docs/phase_metadata/phase_025.json
```
...
Model, govern, and audit: Lifecycle-Aware Conflict Query → Recovery Console API.

## Capability chain

```text
Lifecycle-Aware Conflict Query → Recovery Console API
```
...
```text
Phase doc: docs/phases/phase_025.md
Phase metadata: docs/phase_metadata/phase_025.json
