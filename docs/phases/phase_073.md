# MCMS-118-P073 — Cooperative Binding, Hill Equation, Allostery, and Sigmoidal Enzyme Behavior
...
Phase ID: MCMS-118-P073
Slug: cooperative-binding-hill-equation-allostery-and-sigmoidal-enzyme-behavior
Metadata: docs/phase_metadata/phase_073.json
```
...
Model, govern, and audit: Cooperative Binding → Hill Equation → Allostery → and Sigmoidal Enzyme Behavior.

## Capability chain

```text
Cooperative Binding → Hill Equation → Allostery → and Sigmoidal Enzyme Behavior
```
...
```text
Phase doc: docs/phases/phase_073.md
Phase metadata: docs/phase_metadata/phase_073.json
