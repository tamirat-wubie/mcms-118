# MCMS-118-P061 — Evidence-Aware Learning Cards and Guided Chemistry Tutor Mode
...
Phase ID: MCMS-118-P061
Slug: evidence-aware-learning-cards-and-guided-chemistry-tutor-mode
Metadata: docs/phase_metadata/phase_061.json
```
...
Model, govern, and audit: Evidence-Aware Learning Cards → Guided Chemistry Tutor Mode.

## Capability chain

```text
Evidence-Aware Learning Cards → Guided Chemistry Tutor Mode
```
...
```text
Phase doc: docs/phases/phase_061.md
Phase metadata: docs/phase_metadata/phase_061.json
