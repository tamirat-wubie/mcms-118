# MCMS-118-P092 — NAD Redox Microdomains, NADH Shuttle Coupling, Precursor Branches, and Local Redox Control
...
Phase ID: MCMS-118-P092
Slug: nad-redox-microdomains-nadh-shuttle-coupling-precursor-branches-and-local-redox-control
Metadata: docs/phase_metadata/phase_092.json
```
...
Model, govern, and audit: NAD Redox Microdomains → NADH Shuttle Coupling → Precursor Branches → and Local Redox Control.

## Capability chain

```text
NAD Redox Microdomains → NADH Shuttle Coupling → Precursor Branches → and Local Redox Control
```
...
```text
Phase doc: docs/phases/phase_092.md
Phase metadata: docs/phase_metadata/phase_092.json
