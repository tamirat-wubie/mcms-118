# MCMS-118-P084 — Lipid Species Ontology, Membrane Composition, and Chain-Breaking Antioxidant Defense
...
Phase ID: MCMS-118-P084
Slug: lipid-species-ontology-membrane-composition-and-chain-breaking-antioxidant-defense
Metadata: docs/phase_metadata/phase_084.json
```
...
Model, govern, and audit: Lipid Species Ontology → Membrane Composition → and Chain-Breaking Antioxidant Defense.

## Capability chain

```text
Lipid Species Ontology → Membrane Composition → and Chain-Breaking Antioxidant Defense
```
...
```text
Phase doc: docs/phases/phase_084.md
Phase metadata: docs/phase_metadata/phase_084.json
