# MCMS-118-P002 — Transition Metal Exception Kernel
...
Phase ID: MCMS-118-P002
Slug: transition-metal-exception-kernel
Metadata: docs/phase_metadata/phase_002.json
```
...
Model, govern, and audit: Transition Metal Exception Kernel.

## Capability chain

```text
Transition Metal Exception Kernel
```
...
```text
Phase doc: docs/phases/phase_002.md
Phase metadata: docs/phase_metadata/phase_002.json
