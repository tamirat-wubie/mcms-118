...
Phase ID: MCMS-118-P013
Slug: mvp-blueprint
Metadata: docs/phase_metadata/phase_013.json
```
...
Model, govern, and audit: MVP Blueprint.
...
```text
Phase doc: docs/phases/phase_013.md
Phase metadata: docs/phase_metadata/phase_013.json
