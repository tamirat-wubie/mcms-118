# MCMS-118-P023 — Transactional Workflow Rollback and Failure Recovery
...
Phase ID: MCMS-118-P023
Slug: transactional-workflow-rollback-and-failure-recovery
Metadata: docs/phase_metadata/phase_023.json
```
...
Model, govern, and audit: Transactional Workflow Rollback → Failure Recovery.

## Capability chain

```text
Transactional Workflow Rollback → Failure Recovery
```
...
```text
Phase doc: docs/phases/phase_023.md
Phase metadata: docs/phase_metadata/phase_023.json
