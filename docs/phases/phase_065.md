# MCMS-118-P065 — Source-Grounded Chemistry Evidence, Citation Cards, and Official Data Adapter Layer
...
Phase ID: MCMS-118-P065
Slug: source-grounded-chemistry-evidence-citation-cards-and-official-data-adapter-layer
Metadata: docs/phase_metadata/phase_065.json
```
...
Model, govern, and audit: Source-Grounded Chemistry Evidence → Citation Cards → and Official Data Adapter Layer.

## Capability chain

```text
Source-Grounded Chemistry Evidence → Citation Cards → and Official Data Adapter Layer
```
...
```text
Phase doc: docs/phases/phase_065.md
Phase metadata: docs/phase_metadata/phase_065.json
