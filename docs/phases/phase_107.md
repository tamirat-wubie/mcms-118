# MCMS-118-P107 — Conductance Kinetics, Membrane Capacitance, Cable Equation Approximation, and Ion Channel Distribution
...
Phase ID: MCMS-118-P107
Slug: conductance-kinetics-membrane-capacitance-cable-equation-approximation-and-ion-channel-distribution
Metadata: docs/phase_metadata/phase_107.json
```
...
Model, govern, and audit: Conductance Kinetics → Membrane Capacitance → Cable Equation Approximation → and Ion Channel Distribution.

## Capability chain

```text
Conductance Kinetics → Membrane Capacitance → Cable Equation Approximation → and Ion Channel Distribution
```
...
```text
Phase doc: docs/phases/phase_107.md
Phase metadata: docs/phase_metadata/phase_107.json
