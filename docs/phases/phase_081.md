# MCMS-118-P081 — Redox Signaling, Glutathione Cycle, NADPH Defense, and Cell Fate Boundary
...
Phase ID: MCMS-118-P081
Slug: redox-signaling-glutathione-cycle-nadph-defense-and-cell-fate-boundary
Metadata: docs/phase_metadata/phase_081.json
```
...
Model, govern, and audit: Redox Signaling → Glutathione Cycle → NADPH Defense → and Cell Fate Boundary.

## Capability chain

```text
Redox Signaling → Glutathione Cycle → NADPH Defense → and Cell Fate Boundary
```
...
```text
Phase doc: docs/phases/phase_081.md
Phase metadata: docs/phase_metadata/phase_081.json
