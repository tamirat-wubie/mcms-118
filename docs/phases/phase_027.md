# MCMS-118-P027 — Operator Identity, Permissions, Auth Boundary
...
Phase ID: MCMS-118-P027
Slug: operator-identity-permissions-auth-boundary
Metadata: docs/phase_metadata/phase_027.json
```
...
Model, govern, and audit: Operator Identity → Permissions → Auth Boundary.

## Capability chain

```text
Operator Identity → Permissions → Auth Boundary
```
...
```text
Phase doc: docs/phases/phase_027.md
Phase metadata: docs/phase_metadata/phase_027.json
