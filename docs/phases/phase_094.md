# MCMS-118-P094 — Lactate Export, Monocarboxylate Transport, pH Coupling, and Intercellular Lactate Shuttle
...
Phase ID: MCMS-118-P094
Slug: lactate-export-monocarboxylate-transport-ph-coupling-and-intercellular-lactate-shuttle
Metadata: docs/phase_metadata/phase_094.json
```
...
Model, govern, and audit: Lactate Export → Monocarboxylate Transport → pH Coupling → and Intercellular Lactate Shuttle.

## Capability chain

```text
Lactate Export → Monocarboxylate Transport → pH Coupling → and Intercellular Lactate Shuttle
```
...
```text
Phase doc: docs/phases/phase_094.md
Phase metadata: docs/phase_metadata/phase_094.json
