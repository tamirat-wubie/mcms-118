# MCMS-118-P066 — Evidence Review Console, Source Import Governance, and Citation Coverage Dashboard
...
Phase ID: MCMS-118-P066
Slug: evidence-review-console-source-import-governance-and-citation-coverage-dashboard
Metadata: docs/phase_metadata/phase_066.json
```
...
Model, govern, and audit: Evidence Review Console → Source Import Governance → and Citation Coverage Dashboard.

## Capability chain

```text
Evidence Review Console → Source Import Governance → and Citation Coverage Dashboard
```
...
```text
Phase doc: docs/phases/phase_066.md
Phase metadata: docs/phase_metadata/phase_066.json
