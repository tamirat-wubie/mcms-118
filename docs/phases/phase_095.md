# MCMS-118-P095 — MCT Isoforms, Cell-Type Lactate Roles, Cori Cycle, and Lactate Signaling Boundary
...
Phase ID: MCMS-118-P095
Slug: mct-isoforms-cell-type-lactate-roles-cori-cycle-and-lactate-signaling-boundary
Metadata: docs/phase_metadata/phase_095.json
```
...
Model, govern, and audit: MCT Isoforms → Cell-Type Lactate Roles → Cori Cycle → and Lactate Signaling Boundary.

## Capability chain

```text
MCT Isoforms → Cell-Type Lactate Roles → Cori Cycle → and Lactate Signaling Boundary
```
...
```text
Phase doc: docs/phases/phase_095.md
Phase metadata: docs/phase_metadata/phase_095.json
