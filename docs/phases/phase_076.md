# MCMS-118-P076 — Energy Currency, Cofactor Balance, and Thermodynamic Flux Constraints
...
Phase ID: MCMS-118-P076
Slug: energy-currency-cofactor-balance-and-thermodynamic-flux-constraints
Metadata: docs/phase_metadata/phase_076.json
```
...
Model, govern, and audit: Energy Currency → Cofactor Balance → and Thermodynamic Flux Constraints.

## Capability chain

```text
Energy Currency → Cofactor Balance → and Thermodynamic Flux Constraints
```
...
```text
Phase doc: docs/phases/phase_076.md
Phase metadata: docs/phase_metadata/phase_076.json
