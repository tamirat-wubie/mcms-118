# MCMS-118-P017 — Graph Path Scoring and SQLite Query Integration
...
Phase ID: MCMS-118-P017
Slug: graph-path-scoring-and-sqlite-query-integration
Metadata: docs/phase_metadata/phase_017.json
```
...
Model, govern, and audit: Graph Path Scoring → SQLite Query Integration.

## Capability chain

```text
Graph Path Scoring → SQLite Query Integration
```
...
```text
Phase doc: docs/phases/phase_017.md
Phase metadata: docs/phase_metadata/phase_017.json
