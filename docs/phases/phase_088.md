# MCMS-118-P088 — Energy-Demand Sensing, AMPK/mTOR/PGC-1α Biogenesis Control, and Cellular Adaptation
...
Phase ID: MCMS-118-P088
Slug: energy-demand-sensing-ampk-mtor-pgc-1-biogenesis-control-and-cellular-adaptation
Metadata: docs/phase_metadata/phase_088.json
```
...
Model, govern, and audit: Energy-Demand Sensing → AMPK/mTOR/PGC-1α Biogenesis Control → and Cellular Adaptation.

## Capability chain

```text
Energy-Demand Sensing → AMPK/mTOR/PGC-1α Biogenesis Control → and Cellular Adaptation
```
...
```text
Phase doc: docs/phases/phase_088.md
Phase metadata: docs/phase_metadata/phase_088.json
