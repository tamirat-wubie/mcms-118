# MCMS-118-P090 — NAD Consumption Competition, PARP/CD38-Like Load, DNA Repair Demand, and Sirtuin Tradeoff
...
Phase ID: MCMS-118-P090
Slug: nad-consumption-competition-parp-cd38-like-load-dna-repair-demand-and-sirtuin-tradeoff
Metadata: docs/phase_metadata/phase_090.json
```
...
Model, govern, and audit: NAD Consumption Competition → PARP/CD38-Like Load → DNA Repair Demand → and Sirtuin Tradeoff.

## Capability chain

```text
NAD Consumption Competition → PARP/CD38-Like Load → DNA Repair Demand → and Sirtuin Tradeoff
```
...
```text
Phase doc: docs/phases/phase_090.md
Phase metadata: docs/phase_metadata/phase_090.json
