# MCMS-118-P079 — Mitochondrial Compartments, Shuttle Systems, Proton Leak, and Uncoupling
...
Phase ID: MCMS-118-P079
Slug: mitochondrial-compartments-shuttle-systems-proton-leak-and-uncoupling
Metadata: docs/phase_metadata/phase_079.json
```
...
Model, govern, and audit: Mitochondrial Compartments → Shuttle Systems → Proton Leak → and Uncoupling.

## Capability chain

```text
Mitochondrial Compartments → Shuttle Systems → Proton Leak → and Uncoupling
```
...
```text
Phase doc: docs/phases/phase_079.md
Phase metadata: docs/phase_metadata/phase_079.json
